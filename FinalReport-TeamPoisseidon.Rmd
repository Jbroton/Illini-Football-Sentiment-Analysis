...
There is an extra layer of interactivity which allows the user to use their own search terms and run the analysis we did. This is demonstrated in the 'Results' section where we show what running only 'loviesmith' and 'illinifootball'.

All our plots were created using the ggplot2 package [@ggplot2]. 
